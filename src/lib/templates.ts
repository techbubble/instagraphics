...
<text data-ig-text="title" data-ig-font="primary" x="400" y="84" text-anchor="middle" font-size="34" font-weight="bold" fill="#212529">Our Process</text>
...
<text data-ig-contrast="secondary" data-ig-text="item5" data-ig-font="secondary" x="257" y="305" text-anchor="middle" font-size="18" fill="#ffffff">Iterate</text>
  ...
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" font-family="Arial">
<text data-ig-text="title" data-ig-font="primary" x="400" y="84" text-anchor="middle" font-size="34" font-weight="bold" fill="#212529">Strategy Pyramid</text>
...
<text data-ig-text="item5" data-ig-font="secondary" x="562" y="460" font-size="20" fill="#223333">Foundation</text>
  ...
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" font-family="Arial">
<text data-ig-text="title" data-ig-font="primary" x="400" y="84" text-anchor="middle" font-size="34" font-weight="bold" fill="#212529">Where We Win</text>
...
<text data-ig-text="item1" data-ig-font="secondary" x="150" y="280" text-anchor="middle" font-size="20" fill="#212529">Kickoff</text>
<text data-ig-text="item2" data-ig-font="secondary" x="400" y="280" text-anchor="middle" font-size="20" fill="#212529">Alpha</text>
<text data-ig-text="item3" data-ig-font="secondary" x="650" y="280" text-anchor="middle" font-size="20" fill="#212529">Beta</text>
...
<text data-ig-text="item1" data-ig-font="secondary" x="150" y="280" text-anchor="middle" font-size="20" fill="#212529">Kickoff</text>
<text data-ig-text="item2" data-ig-font="secondary" x="317" y="280" text-anchor="middle" font-size="20" fill="#212529">Alpha</text>
<text data-ig-text="item3" data-ig-font="secondary" x="483" y="280" text-anchor="middle" font-size="20" fill="#212529">Beta</text>
...
<text data-ig-text="item1" data-ig-font="secondary" x="150" y="280" text-anchor="middle" font-size="17" fill="#212529">Kickoff</text>
<text data-ig-text="item2" data-ig-font="secondary" x="275" y="280" text-anchor="middle" font-size="17" fill="#212529">Alpha</text>
<text data-ig-text="item3" data-ig-font="secondary" x="400" y="280" text-anchor="middle" font-size="17" fill="#212529">Beta</text>
<text data-ig-text="item4" data-ig-font="secondary" x="525" y="280" text-anchor="middle" font-size="17" fill="#212529">Launch</text>
<text data-ig-text="item5" data-ig-font="secondary" x="650" y="280" text-anchor="middle" font-size="17" fill="#212529">Scale</text>
<text data-ig-text="other1" data-ig-font="tertiary" x="400" y="400" text-anchor="middle" font-size="18" fill="#495057">Fiscal Year</text>
</svg>`,
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" font-family="Arial">
<text data-ig-text="title" data-ig-font="primary" x="400" y="84" text-anchor="middle" font-size="34" font-weight="bold" fill="#212529">How to use</text>
