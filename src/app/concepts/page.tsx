...
function RootsAndBranches() {
  ...
  return (
    <>
      ...
      <path d="M445 706 C 400 748 340 760 265 800" fill="none" stroke={C.accent} strokeWidth="16" strokeLinecap="round" />
      <path d="M500 710 C 500 750 500 775 500 805" fill="none" stroke={C.accent} strokeWidth="16" strokeLinecap="round" />
      <path d="M555 706 C 600 748 660 760 735 800" fill="none" stroke={C.accent} strokeWidth="16" strokeLinecap="round" />
      {roots.map(([x, label]) => (
